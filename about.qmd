# About the ECTQG {#sec-about}

The [**European Colloquium on Theoretical and Quantitative Geography** - **ECTQG**]{style="color: gold"} is both a **biannual scientific meeting** and a **community of scientists** from all over Europe, who are interested in **advancing quantitative methods and theories with a strong geographical dimension**.
...
More about the **ECTQG origins and its aims** before the millenium can be found in David Unwin, Euroquant at 21: "coming of age"? (1999). Recently, Sylvain Cuyala (2016) conducted an analysis on how the network further developed and knowledge was diffused.

The **list of previous events** and their programme (where available) can be found at the [Colloquia](colloquia.html) page of the present website.

The ECTQG is a **non-institutionalised community** without a board, a members list or a specific journal. The **magic of this network** is its self-organisation. Its persistence across time is a demonstration of its adaptive capacity and relevance to geographical research (see Denise Pumain, Should the ECTQG be institutionalised? (2017).

Communication flow is assured informally during the biannual meeting and with the EUROTQG mailing list in the intervening periods. Anyone interested in quantitative geography research is welcome to subscribe to this European List of diffusion for Theoretical and Quantitative Geography ([@Eurotqg](eurotqg.html)) or contact ECTQG regular participants ([here](informal.html))
